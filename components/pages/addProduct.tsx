...
const AddProductMutation= useMutation({
  ...
  return (
    <div className="h-screen w-full  flex  justify-center ">
      <div className="h-5/6 w-3/4 flex flex-col lg:w-1/2 lg:flex-row justify-around items-center border-2 border-gray-300 rounded-md shadow-md dark:bg-zinc-900 dark:border-gray-600">
        <div className="hidden lg:flex flex-col w-1/2 h-full p-5 border-r-2 border-gray-200 dark:border-gray-600">
        ...
        <div className="lg:w-1/2 w-full h-full p-5 flex justify-around items-center ">
        ...
        <UploadButton className="lg:hidden"
            endpoint="imageUploader"
            onClientUploadComplete={(res) => {
              setimgurl(res[0].url);
              console.log("Files: ", res);
