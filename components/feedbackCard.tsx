...
export default function FeedbackCard(props:any){
    ...
    <div className="h-40 w-80   rounded-sm shadow-sm border-2 border-gray-100 flex flex-col justify-between items-center dark:bg-zinc-900 dark:border-gray-600 ">
